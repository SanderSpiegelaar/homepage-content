...
- Add the `effect` package and establish a small, documented convention for server-side Effect programs.
...
- Preserves Next.js, Better Auth, Drizzle, Zod, n8n, logging, and public Promise-based interfaces unless a focused migration proves a smaller compatible boundary.
